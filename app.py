...
app = Flask(__name__)
database_url = os.environ.get('DATABASE_URL', 'postgresql://root:3bwYw8hKY0Bw8KmOfYM5TCSUkZG3y10q@dpg-cvlg9195pdvs73a4goe0-a.oregon-postgres.render.com:5432/joyass')
